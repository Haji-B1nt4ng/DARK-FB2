    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://facebook.com/memekjandaa')
                time.sleep(2)
                menu()
